...
public class MainActivity extends AppCompatActivity
    ...
    */
    ...
    public void onDoneClicked(View view) {
        ...
        mTurnData.hand = game.getPlayers().get(1).getHand();
    ...
    public void updateMatch(TurnBasedMatch match) {
        ...
        switch (turnStatus) {
            case TurnBasedMatch.MATCH_TURN_STATUS_MY_TURN:
                mTurnData = MainTurn.unpersist(mMatch.getData());
                setGameplayUI();
                return;
    ...
    /*
Progresses game to player_intro_screen after the "Start Game" button is pressed
